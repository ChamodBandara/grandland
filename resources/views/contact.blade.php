...
<html lang="en">
  <head>
    ...
    <title>Shared on THEMELOCK.COM - Contact || Crank || Crank HTML 5 Template</title>
    <!-- favicons Icons -->
    <link
    ...
    <div class="page-wrapper">
      ...
      <footer class="footer-container">
        <div class="footer-content">
            <div class="footer-logo-section">
                <div class="footer-logo">
                    <img src="assets/images/resources/logo-1.png" alt="Company Logo">
                  
                </div>
                <div class="company-details">
                    <p><i class="fas fa-map-marker-alt" style="color: #e63946; margin-right: 5px;"></i> 123 Business Ave, New York</p>
                    <p><i class="fas fa-phone" style="color: #e63946; margin-right: 5px;"></i> +1 (555) 123-4567</p>
                    <p><i class="fas fa-envelope" style="color: #e63946; margin-right: 5px;"></i> info@company.com</p>
                </div>
            </div>
            ...
            <div class="useful-links">
                ...
                <ul>
                    <li><a href="#"><i class="fas fa-chevron-right" style="margin-right: 5px; font-size: 10px;"></i> Home</a></li>
                    <li><a href="#"><i class="fas fa-chevron-right" style="margin-right: 5px; font-size: 10px;"></i> About</a></li>
                    <li><a href="#"><i class="fas fa-chevron-right" style="margin-right: 5px; font-size: 10px;"></i> Services</a></li>
                    <li><a href="#"><i class="fas fa-chevron-right" style="margin-right: 5px; font-size: 10px;"></i> Contact</a></li>
                </ul>
            </div>
            ...
            <div class="legal-links">
                ...
                <ul>
                    <li><a href="#"><i class="fas fa-chevron-right" style="margin-right: 5px; font-size: 10px;"></i> Returns Policy</a></li>
                    <li><a href="#"><i class="fas fa-chevron-right" style="margin-right: 5px; font-size: 10px;"></i> Privacy Policy</a></li>
                    <li><a href="#"><i class="fas fa-chevron-right" style="margin-right: 5px; font-size: 10px;"></i> Terms of Service</a></li>
                    <li><a href="#"><i class="fas fa-chevron-right" style="margin-right: 5px; font-size: 10px;"></i> Shipping Policy</a></li>
                </ul>
            </div>

            <div class="location">
                <h3 class="footer-heading">Our Location</h3>
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3022.215573036126!2d-73.98784492423955!3d40.74844097138998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c259a9b3117469%3A0xd134e199a405a163!2sEmpire%20State%20Building!5e0!3m2!1sen!2sus!4v1689871234567!5m2!1sen!2sus" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        ...
        <div class="footer-bottom">
            <p>&copy; <span id="year"></span> CompanyName. All Rights Reserved.</p>
        </div>
    </footer>
