        ...
        <div class="container">
            <div class="privacy-policy">
                ...
                <section>
                    ...
                    operating system.</p>
                    <p>Email marketing: With your permission, we may send you emails about our store, new products 
                    and other updates.</p>
                </section>
                ...
                <section>
                    ...
                    our collecting it and using it for that specific reason only.</p>
                ...
                <section>
                    <h2>WOOCOMMERCE & PAYHERE</h2>
                    <p>Our store is hosted on WooCommerce. They provide us with the online e-commerce platform 
                    that allows us to sell our products and services to you.</p>
                    <p>Your data is stored through WooCommerce's data storage, databases and the general 
                    WooCommerce application. They store your data on a secure server behind a firewall.</p>
                    <p>Online payments are handled by Payhere.</p>
                </section>
                ...
                <section>
                    <h2>COOKIES</h2>
                    <p>To keep track of cart data, WooCommerce makes use of 3 cookies:</p>
                    <ul>
                        <li>woocommerce_cart_hash</li>
                        <li>woocommerce_items_in_cart</li>
                        <li>wpwoocommerce_session</li>
                    </ul>
                    <p>The first two cookies contain information about the cart as a whole and helps WooCommerce 
                    know when the cart data changes. The final cookie (wpwoocommerce_session) contains a 
                    unique code for each customer so that it knows where to find the cart data in the database for 
                    each customer. No personal information is stored within these cookies.</p>
                </section>
                ...
                <section>
                    ...
                    any, we use and/or disclose it.</p>
